...
A list is defined containing temperatures in Celcius.<br>
...
You do not have to change list <code>celcius_list</code>, but rather, print each element's equivalent Farenheit temperature to the screen.<br>
