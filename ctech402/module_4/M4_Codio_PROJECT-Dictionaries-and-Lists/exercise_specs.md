...
To make it easier for employees to remember their new office numbers, the office numbers will remain the same with the exception of the first number (floor number). For example, Frank's office will change from 204 to 304 once he moves to the third floor. Print the updated office list at the end of your program.
